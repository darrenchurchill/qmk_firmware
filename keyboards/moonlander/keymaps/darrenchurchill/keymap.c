...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT_moonlander_custom_wrapper(
        ...
        ____________MOUSE_4_L4_____________,         _______,        _______,         _____________MOUSE_4_R4____________,
                                   _______, _______,                          _______, _______
    ),
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [_QWERTY] = {
        ...
        {HSV_OFF}, {HSV_ON},   {HSV_CTL}, {HSV_CTL}, {HSV_QUOT},
        {HSV_OFF}, {HSV_ON},   {HSV_LYR}, {HSV_ALT}, {HSV_QUOT},
    ...
    [_RAISE] = {
        ...
        {HSV_OFF}, {HSV_SELWD}, {HSV_OFF}, {HSV_ALT}, {HSV_LYR_ESC},
        {HSV_OFF}, {HSV_OFF},   {HSV_SFT}, {HSV_SFT}, {HSV_OFF},
        {HSV_OFF}, {HSV_SELWD}, {HSV_GUI}, {HSV_OFF}, {HSV_OFF},
