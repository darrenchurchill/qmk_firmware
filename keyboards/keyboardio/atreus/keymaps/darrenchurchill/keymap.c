...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RS] = LAYOUT( /* [> Raise <] */
    ...
    KC_TRNS, KC_TRNS, KC_TRNS,           KC_TRNS, QK_BOOT, QK_RBT,  KC_TRNS, KC_TRNS, SGUI(KC_LBRC), SGUI(KC_RBRC), KC_TRNS,  KC_TRNS,
    CW_TOGG, NK_OFF,  KC_TRNS,           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS,       KC_TRNS,  KC_TRNS
    )
};
