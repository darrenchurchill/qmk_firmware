...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    CTL_T(KC_GRV), ALT_T(KC_ESC), KC_TAB,      KC_LGUI,     MO(_LW), KC_LSFT,        KC_BSPC, KC_SPC, LT(_RS, KC_QUOT), KC_ENT,         KC_QUOT,       KC_DQUO
    ),
  ...
  [_RS] = LAYOUT( /* [> Raise <] */
    ...
    _______, _______, _______,           _______, QK_BOOT, QK_RBT,  KC_DEL,  _______, SGUI(KC_LBRC), SGUI(KC_RBRC), LCTL(KC_PGUP), LCTL(KC_PGDN),
