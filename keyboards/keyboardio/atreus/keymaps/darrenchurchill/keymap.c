...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK_DH] = LAYOUT_atreus_wrapper(
        ...
        _________________BASE_5_L4_________________, _______, _______, _________________BASE_5_R4_________________
    ),

    [_QWERTY_NO_MODS] = LAYOUT_atreus_wrapper(
        _________________QWERTY_L1_________________,                   _________________QWERTY_R1_________________,
        _________________QWERTY_L2_________________,                   _____________QWERTY_NO_MODS_R2_____________,
